...
class Test_test_sofa(unittest.TestCase):
    def test_A(self):
        ...
        for number in numbers:
            self.assertTrue(number_data_sofa.check_number(number))
    def test_B(self):
        numbers=["1", "12", "123", "1234", "12345", "123456", "1234567", "1345678", "123456789", "12345678900",
                 ...
                 "8-932-988-09-09-09", "7123344",  "3.982.984.09.09", "3()345-45-67"]
        for number in numbers:
            self.assertFalse(number_data_sofa.check_number(number))
